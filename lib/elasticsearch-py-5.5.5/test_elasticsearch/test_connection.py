...
from elasticsearch5.exceptions import TransportError, ConflictError, RequestError, NotFoundError
from elasticsearch5.connection import RequestsHttpConnection, \
...
class TestRequestsConnection(TestCase):
    ...
    @patch('elasticsearch5.connection.base.logger')
    ...
    @patch('elasticsearch5.connection.base.tracer')
    @patch('elasticsearch5.connection.base.logger')
